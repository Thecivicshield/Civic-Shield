...
export default function EvidenceSection({ evidence, isAdmin, onDeleteEvidence, accentColor }: EvidenceSectionProps) {
  ...
  return (
    <section id="evidence" className="py-24 bg-[#002366] border-t border-[#d4af37]/25">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-8 bg-[#001233]/90 p-4 rounded-sm border border-[#d4af37]/20">
          {/* Tabs */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredItems.map(item => (
            <div 
              key={item.id} 
              className="bg-[#001233] rounded-sm border border-[#d4af37]/20 hover:border-[#d4af37]/60 hover:shadow-[0_0_20px_rgba(212,175,55,0.08)] shadow-xl p-5 flex flex-col justify-between transition-all duration-300 group h-auto"
            >
      ...
      {viewingPdf && (
        <div className="fixed inset-0 z-50 bg-[#001233]/90 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#001a4d] rounded-sm w-full max-w-5xl h-[85vh] border border-[#d4af37]/30 flex flex-col overflow-hidden shadow-2xl">
      ...
      {/* Video View Modal */}
      {viewingVideo && (
        <div className="fixed inset-0 z-50 bg-[#001233]/95 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#001a4d] rounded-sm w-full max-w-3xl border border-[#d4af37]/30 flex flex-col overflow-hidden shadow-2xl">
            <div className="bg-[#001233] px-4 py-3 border-b border-[#d4af37]/15 flex items-center justify-between font-serif">
              <div className="flex items-center gap-2">
