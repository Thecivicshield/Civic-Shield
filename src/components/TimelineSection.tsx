...
export default function TimelineSection({ events, isAdmin, onUpdateEvent, accentColor }: TimelineSectionProps) {
  ...
  return (
    <section id="timeline" className="py-24 bg-[#001a4d] border-t border-[#d4af37]/25 relative">
              ...
              <div key={idx} className="relative group">
                ...
                <div className="absolute -left-[35px] sm:-left-[41px] top-1.5 focus:outline-none shrink-0 z-20">
                  {isAdmin ? (
                    ...
                    <div className="rounded-sm bg-[#001a4d] border border-[#d4af37]/20 p-0.5 shadow-xl">
                      {event.completed ? (
                ...
                {/* Event block card */}
                <div className="bg-[#001233] rounded-sm border border-[#d4af37]/20 hover:border-[#d4af37]/40 p-5 shadow-xl transition-all h-auto">
