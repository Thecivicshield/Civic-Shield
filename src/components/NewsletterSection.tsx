...
export default function NewsletterSection({ onSubscribe }: NewsletterSectionProps) {
  ...
  return (
    <section id="newsletter" className="py-24 bg-[#001a4d] border-t border-[#d4af37]/25 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10 text-center space-y-8">
        <div className="p-3 bg-[#d4af37]/10 border border-[#d4af37]/20 rounded-sm inline-flex text-[#d4af37]">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="px-6 py-3 bg-[#d4af37] hover:bg-[#c39e2e] disabled:bg-[#002366] text-[#001a4d] font-bold text-xs tracking-wider uppercase rounded-sm transition-all cursor-pointer flex items-center justify-center gap-2 shrink-0"
          >
            {loading ? (
