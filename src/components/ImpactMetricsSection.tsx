...
export default function ImpactMetricsSection({
  ...
  return (
    <section id="impact-metrics" className="py-24 bg-[#001233] border-t border-[#d4af37]/25 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 bg-[#001a4d]/85 p-6 sm:p-8 rounded-sm border border-[#d4af37]/15 shadow-2xl relative">
          ...
          <div className="lg:col-span-12 xl:col-span-5 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              {activeMetrics.map((item, idx) => (
                <div 
                  key={idx} 
                  className="bg-[#001233]/90 border border-[#d4af37]/15 p-5 rounded-sm hover:border-[#d4af37]/45 transition-all text-center flex flex-col justify-between"
                >
            ...
            {isAdmin && (
              <div className="bg-[#001c4a] border border-dashed border-[#d4af37]/40 p-5 rounded-sm space-y-4">
