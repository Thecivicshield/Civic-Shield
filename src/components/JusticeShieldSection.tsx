...
import { Scale, HeartHandshake, FileText, Gavel, BookOpen, AlertCircle, CheckCircle, HelpCircle, Clock, Smartphone, Trash2, Plus } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 bg-[#001233]/95 border border-[#d4af37]/20 p-6 sm:p-8 rounded-sm shadow-2xl space-y-6 relative">
            ...
            {isEditingActiveLaw && isAdmin && onUpdateLaws && laws[activeLawIndex] ? (
              <div className="space-y-4 bg-[#00173d] p-4 rounded-sm border border-[#d4af37]/20 animate-in fade-in duration-200">
                <div>
                        ...
                        {isAdmin && onUpdateMyths && (
                          <div className="flex items-center gap-1.5">
                            <button
                              ...
                              className="text-[9px] font-mono text-gray-400 hover:text-[#d4af37] transition-colors cursor-pointer"
