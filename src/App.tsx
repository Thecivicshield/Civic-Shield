...
import { CivicShieldData, LayoutBlock, BlogPost, EvidenceItem, AnonymousQuestion, NewsletterSub } from "./types";
...
export default function App() {
  ...
  return (
    <div className="min-h-screen font-sans antialiased text-gray-100 flex flex-col justify-between" style={{ backgroundColor: "#001a4d" }}>
